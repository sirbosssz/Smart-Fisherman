  ...
  data: {
    ...
    weatherData: {
      lunarDay: {
        phase: 'กำลังโหลด',
        day: 0,
        img: '/_asset/image/full-moon.svg'
      },
      temperature: {
        temp: 0,
        max: 0,
        ...
        axios({
          ...
          if (weatherPage.weatherData.lunarDay.phase == 'ข้างขึ้น') {
            if (weatherPage.weatherData.lunarDay.day < 8) {
              weatherPage.weatherData.lunarDay.img = '/_asset/image/waning-crescent.svg'
            } else if (weatherPage.weatherData.lunarDay.day == 8) {
              weatherPage.weatherData.lunarDay.img = '/_asset/image/third-quater.svg'
            } else if (weatherPage.weatherData.lunarDay.day < 15) {
              weatherPage.weatherData.lunarDay.img = '/_asset/image/waning-gibbous.svg'
            } else {
              weatherPage.weatherData.lunarDay.img = '/_asset/image/full-moon.svg'
            }
          } else {
            if (weatherPage.weatherData.lunarDay.day < 8) {
              weatherPage.weatherData.lunarDay.img = '/_asset/image/waxing-gibbous.svg'
            } else if (weatherPage.weatherData.lunarDay.day == 8) {
              weatherPage.weatherData.lunarDay.img = '/_asset/image/first-quater.svg'
            } else if (weatherPage.weatherData.lunarDay.day < 15) {
              weatherPage.weatherData.lunarDay.img = '/_asset/image/waxing-crescent.svg'
            } else {
              weatherPage.weatherData.lunarDay.img = '/_asset/image/new-moon.svg'
            }
          }
    ...
    axios({
      ...
      if (this.weatherData.lunarDay.phase == 'ข้างขึ้น') {
        if (this.weatherData.lunarDay.day < 8) {
          this.weatherData.lunarDay.img = '/_asset/image/waning-crescent.svg'
        } else if (this.weatherData.lunarDay.day == 8) {
          this.weatherData.lunarDay.img = '/_asset/image/third-quater.svg'
        } else if (this.weatherData.lunarDay.day < 15) {
          this.weatherData.lunarDay.img = '/_asset/image/waning-gibbous.svg'
        } else {
          this.weatherData.lunarDay.img = '/_asset/image/full-moon.svg'
        }
      } else {
        if (this.weatherData.lunarDay.day < 8) {
          this.weatherData.lunarDay.img = '/_asset/image/waxing-gibbous.svg'
        } else if (this.weatherData.lunarDay.day == 8) {
          this.weatherData.lunarDay.img = '/_asset/image/first-quater.svg'
        } else if (this.weatherData.lunarDay.day < 15) {
          this.weatherData.lunarDay.img = '/_asset/image/waxing-crescent.svg'
        } else {
          this.weatherData.lunarDay.img = '/_asset/image/new-moon.svg'
        }
      }
